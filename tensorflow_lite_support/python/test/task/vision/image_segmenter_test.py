...
_EXPECTED_COLORED_LABELS = [
  {'r': 0, 'g': 0, 'b': 0, 'class_name': 'background'},
  {'r': 128, 'g': 0, 'b': 0, 'class_name': 'aeroplane'},
  {'r': 0, 'g': 128, 'b': 0, 'class_name': 'bicycle'},
  {'r': 128, 'g': 128, 'b': 0, 'class_name': 'bird'},
  {'r': 0, 'g': 0, 'b': 128, 'class_name': 'boat'},
  {'r': 128, 'g': 0, 'b': 128, 'class_name': 'bottle'},
  {'r': 0, 'g': 128, 'b': 128, 'class_name': 'bus'},
  {'r': 128, 'g': 128, 'b': 128, 'class_name': 'car'},
  {'r': 64, 'g': 0, 'b': 0, 'class_name': 'cat'},
  {'r': 192, 'g': 0, 'b': 0, 'class_name': 'chair'},
  {'r': 64, 'g': 128, 'b': 0, 'class_name': 'cow'},
  {'r': 192, 'g': 128, 'b': 0, 'class_name': 'dining table'},
  {'r': 64, 'g': 0, 'b': 128, 'class_name': 'dog'},
  {'r': 192, 'g': 0, 'b': 128, 'class_name': 'horse'},
  {'r': 64, 'g': 128, 'b': 128, 'class_name': 'motorbike'},
  {'r': 192, 'g': 128, 'b': 128, 'class_name': 'person'},
  {'r': 0, 'g': 64, 'b': 0, 'class_name': 'potted plant'},
  {'r': 128, 'g': 64, 'b': 0, 'class_name': 'sheep'},
  {'r': 0, 'g': 192, 'b': 0, 'class_name': 'sofa'},
  {'r': 128, 'g': 192, 'b': 0, 'class_name': 'train'},
  {'r': 0, 'g': 64, 'b': 128, 'class_name': 'tv'}
]
...
class ImageSegmenterTest(parameterized.TestCase, base_test.BaseTestCase):
  ...
  def test_segment_model(self, model_file_type, expected_colored_labels):
    ...
    self.assertEqual(len(colored_labels), len(expected_colored_labels),
