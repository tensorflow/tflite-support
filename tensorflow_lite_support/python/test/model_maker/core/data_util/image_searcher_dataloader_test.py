...
from tensorflow_lite_support.python.model_maker.core.data_util import image_searcher_dataloader
import unittest
from tensorflow_lite_support.python.test import test_util


class ImageSearcherDataloaderTest(unittest.TestCase):
  ...
  def test_from_folder(self):
    ...
    self.assertEqual(data_loader.dataset.shape, (3, 1024))
