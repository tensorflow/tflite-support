...
class Pos:
  """Represents the logit and offset of the answer related to context.

  Attributes:
    start: The start offset index of the answer.
    end: The end offset index of the answer.
    logit: The logit of the answer.
  """
...
class QuestionAnswererResult:
  """The list of answers generated by the BertQuestionAnswerer.
  ...
  def to_pb2(self) -> _QuestionAnswererResultProto:
    """Generates a protobuf object to pass to the C++ layer."""
    return _QuestionAnswererResultProto(answers=[
        answer.to_pb2() for answer in self.answers
    ])
  ...
  def create_from_pb2(
    ...
    return QuestionAnswererResult(answers=[
        QaAnswer.create_from_pb2(answer)
        for answer in pb2_obj.answers
    ])
