...
class Classifications:
  ...
  Attributes:
    categories: The array of predicted classes, usually sorted by descending
      scores (e.g. from high to low probability).
    head_index: The index of the classifier head these classes refer to.
...
class ClassificationResult:
  ...
  @doc_controls.do_not_generate_docs
  def to_pb2(self) -> _ClassificationResult:
    """Generates a protobuf object to pass to the C++ layer."""
  ...
  def create_from_pb2(
    ...
    """Creates a `ClassificationResult` object from the given protobuf
    object."""
