...
_TEST_DIR = "third_party/tensorflow_lite_support/metadata/python/tests/testdata/bert_nl_classifier/"
_MODEL = "../testdata/bert_nl_classifier/sst2_mobilebert_quant.tflite"
_LABEL_FILE = _TEST_DIR + "labels.txt"
_VOCAB_FILE = _TEST_DIR + "vocab.txt"
_SP_MODEL_FILE = _TEST_DIR + "sentence_piece.model"
_DELIM_REGEX_PATTERN = r"[^\w\']+"
_JSON_FOR_INFERENCE_WITH_BERT = "../testdata/bert_nl_classifier/sst2_mobilebert_quant_with_bert.json"
_JSON_FOR_INFERENCE_WITH_SENTENCE_PIECE = "../testdata/bert_nl_classifier/sst2_mobilebert_quant_with_sentence_piece.json"
_JSON_DEFAULT = "../testdata/bert_nl_classifier/sst2_mobilebert_quant_default.json"
...
class MetadataWriterTest(tf.test.TestCase):
  ...
  def test_create_for_inference_with_sentence_piece_should_succeed(self):
    writer = bert_nl_classifier.MetadataWriter.create_for_inference(
        test_utils.load_file(_MODEL),
        metadata_info.SentencePieceTokenizerMd(_SP_MODEL_FILE, _VOCAB_FILE),
        [_LABEL_FILE])
