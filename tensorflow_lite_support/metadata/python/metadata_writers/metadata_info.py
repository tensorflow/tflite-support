...
class RegexTokenizerMd:
  ...
  def create_metadata(self) -> _metadata_fb.ProcessUnitT:
    ...
    vocab.description = self._VOCAB_FILE_DESCRIPTION
...
class BertTokenizerMd:
  ...
  _VOCAB_FILE_DESCRIPTION = "Vocabulary file for the BertTokenizer."
...
class SentencePieceTokenizerMd:
  ...
  _VOCAB_FILE_DESCRIPTION = (
      "Vocabulary file for the sentence piece tokenizer. This file is "
