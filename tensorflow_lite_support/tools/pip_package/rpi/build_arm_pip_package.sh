...
bazel build -c opt --config=elinux_armhf --define darwinn_portable=1 tensorflow_lite_support/tools/pip_package:build_pip_package
...
bazel build -c opt --config=elinux_aarch64 --define darwinn_portable=1 tensorflow_lite_support/tools/pip_package:build_pip_package
