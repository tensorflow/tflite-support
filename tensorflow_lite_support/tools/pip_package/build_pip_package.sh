...
function prepare_src() {
  ...
  if ! is_windows; then
    ...
    cp tensorflow_lite_support/tools/pip_package/task_vision.__init__.py ${TMPDIR}/tflite_support/task/text/__init__.py
    mkdir ${TMPDIR}/tflite_support/task/audio
    cp tensorflow_lite_support/tools/pip_package/task_vision.__init__.py ${TMPDIR}/tflite_support/task/audio/__init__.py
