 ...
 *
 * @param metadata User-defined metadata about the result. This could be a label, a unique ID, a serialized proto of some sort, etc.User-defined metadata about the result. This could be a label, a unique ID, a serialized proto of some sort, etc.
 ...
 *
 * @param nearestNeighbors An array of nearest neighbors detected in the search sorted by increasing disance order.
 *
