 ...
 * @param bufferSize Maximum number of elements the internal buffer of `TFLAudioRecord` can hold at
 * any given point of time. The buffer length should be a multiple of format.channelCount.
