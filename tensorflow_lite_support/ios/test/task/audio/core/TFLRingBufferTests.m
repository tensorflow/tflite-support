...
- (void)testLoadSucceedsWithFullLengthBuffer {
  ...
  XCTAssertTrue([ringBuffer loadFloatData:&(inData[0]) dataSize:inDataLength offset:0 size:inDataLength error:nil]);
...
- (void)testLoadSucceedsWithPartialLengthBuffer {
  ...
  XCTAssertTrue([ringBuffer loadFloatData:&(inData[0]) dataSize:inDataSize offset:0 size:inDataSize error:nil]);
...
- (void)testLoadSucceedsByShiftingOutOldElements {
  ...
  XCTAssertTrue([ringBuffer loadFloatData:&(initialArray[0]) dataSize:initialDataSize offset:0 size:initialDataSize error:nil]);
  ...
  XCTAssertTrue([ringBuffer loadFloatData:&(inArray[0]) dataSize:inDataSize offset:0 size:inDataSize error:nil]);
...
- (void)testLoadSucceedsWithMostRecentElements {
  ...
  XCTAssertTrue([ringBuffer loadFloatData:&(sourceArray[0]) dataSize:sourceDataSize offset:0 size:sourceDataSize error:nil]);
...
- (void)testLoadSucceedsWithOffseAndMostRecentElements {
  ...
  XCTAssertTrue([ringBuffer loadFloatData:&(inArray[0]) dataSize:totalInSize offset:offset size:inDataSize error:nil]);
...
- (void)testLoadFailsWithIndexOutofBounds {
  ...
  NSError *error = nil;
  XCTAssertFalse([ringBuffer loadFloatData:&(inArray[0]) dataSize:initialDataSize offset:offset size:inDataSize error:&error]);
